...
[![CRAN status](https://www.r-pkg.org/badges/version/mappeR)](https://CRAN.R-project.org/package=mappeR) [![](https://cranlogs.r-pkg.org/badges/mappeR)](https://cran.r-project.org/package=mappeR) [![R-CMD-check](https://github.com/Uiowa-Applied-Topology/mappeR/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/Uiowa-Applied-Topology/mappeR/actions/workflows/R-CMD-check.yaml)
...
The object returned by `create_mapper_object` is a list of two data frames containing vertex and edge information. Its elements can be fed into familiar network visualization packages; for example:

-   `igraph`: `graph_from_data_frame(mapper[[2]], directed = FALSE, vertices = mapper[[1]])`
-   `RCy3` [(Cytoscape)](https://cytoscape.org/): `createNetworkFromDataFrames(mapper[[1]], mapper[[2]])`
