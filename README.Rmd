...
`mappeR` includes functionality to interface with `Cytoscape`, which can be downloaded here: <https://cytoscape.org/>.

To install the most recent CRAN upload of this package, run the following:
